...
<div class="mt-10 mb-0">
	<div class="text-center bg-green-900 p-2 pb-3 md:p-5 md:pb-3">
		<span class="text-white ld:text-3xl md:text-2xl text-xl block font-semibold">Featured Properties</span>
	...
	<div class="@if ( $featuredProperty->count() >= 6 ) pb-20 @else pb-0 @endif px-20 pt-5 block relative overflow-hidden bg-white">
		@if ( $featuredProperty->count() >= 6 )
			<a href="{{ url('listings/property/featured') }}" class=" bg-green-600 text-white text-sm w-max p-3 px-5 rounded hover:bg-green-900">Show More</a>
		@endif
	</div>
</div>
@endif