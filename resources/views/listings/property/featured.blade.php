...
@section('title', 'Property - Featured')

@section('products_meta_tags')
    <meta name="description" content="Samorl Featured Properties">
    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="Featured Samorl Properties">
    <meta itemprop="description" content="Check Out Featured Properties on Samorl Properties">
    ...
    <meta name="twitter:title" content="Featured Properties">
    <meta property="twitter:url" content="https://properties.samorl.com.ng/listings/property/featured" />
    <meta name="twitter:description" content="Check Out Featured Properties on Samorl Properties">
    ...
    <meta property="og:url" content="https://properties.samorl.com.ng/listings/property/featured" />
    <meta property="og:image" content="https://properties.samorl.com.ng/images/main_seo_image.jpg" />
    <meta property="og:description" content="Check Out Featured Properties on Samorl Properties" />
...
@section('content')
	...
	<div class="flex flex-col items-center align-middle justify-center w-full h-52 text-center bg-cover bg-center short_banner relative"
		...
		<span class="font-bold uppercase text-white text-2xl md:text-4xl block w-full az_custom_front tracking-wide break-words z-50 pb-12 capitalize" >Featured Properties</span>
	...
	<main class="p-0 m-0 mb-0 mt-10 mb-10 px-4 md:px-7 lg:px-20 relative overflow-hidden">
		...
		<div id="main_property" class="block relative pt-16 md:pt-4 mt-40 md:mt-5 px-0 sm:px-3 lg:px-8">
			...
			<div class="p-5 md:p-10 bg-white rounded block relative overflow-hidden">
				@if ( $featuredProperty->count() > 0 )
				<span class="font-semibold text-left block relative text-xl"> Featured Properties </span>
				<div class="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 gap-10 px-0 py-5 bg-white pb-2">
					<!-- Properties Card -->
					@foreach( $featuredProperty as $property )
					    @php
