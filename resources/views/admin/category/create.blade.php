	            ...
	            <main class="bg-white-300 flex-1 p-3 overflow-hidden pt-10">
                    ...
                    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                            ...
                            <div class="p-3">
                                <form class="w-full" action="/admin/category/create" method="post">
                                   @include('admin.category.form')
                                    <button type="submit" class="bg-blue-800 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-800 rounded">Create</button>
                                </form>
                            </div>
                        </div>
                    </div>
