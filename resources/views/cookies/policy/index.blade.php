...
@section('products_meta_tags')
    <!-- Twitter Card data -->
    <meta name="twitter:card" content="Samorl Properties | Cookies Policy">
    <meta name="twitter:title" content="Propeties for sale, to rent ....">
    <meta property="twitter:url" content="https://properties.samorl.com.ng/cookies-policy" />
    ...
    <!-- Open Graph data -->
    <meta property="og:title" content="Samorl Properties | Cookies Policy" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://properties.samorl.com.ng/cookies-policy" />
...
@section('content')
	...
	<div class="flex flex-col items-center align-middle justify-center w-full h-52 text-center bg-cover bg-center short_banner relative"
		...
		<span class="font-bold uppercase text-white text-2xl md:text-4xl block w-full az_custom_front tracking-wide break-words z-50 pb-12 capitalize" >Cookies Policy</span>
	...
	<main class="p-0 m-0 mb-0 mt-10 mb-10 px-4 md:px-7 lg:px-20 relative overflow-hidden">
		<div id="main_property" class="block relative pt-16 md:pt-4 mt-40 md:mt-5 px-0 sm:px-3 lg:px-8">
			<div class="p-5 md:p-10 bg-white rounded block relative overflow-hidden">
				<h3 class="font-bold">Cookies Policy:</h3>

				<span class="py-5 relative block">
					We use cookies to help improve your experience of  https://listproperty.ng/ . This cookie policy is part of List Property trading name of N & O Online Services, ( ”A Nigerian Registered Business”)’ s privacy policy, and covers the use of cookies between your device and our site. List Property is a free classified ads listing website. We also provide basic information on third-party services we may use, who may also use cookies as part of their service, though they are not covered by our policy <br>
					If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from https://List Property.com/ , with the understanding that we may be unable to provide you with some of your desired content and services.
				</span>
				<span class="py-5 relative block">
					What is a cookie? <br>
